...
namespace TEST
{
    public partial class WHBillboardOrderStatus : Form
    {
        System.Timers.Timer t = new System.Timers.Timer(100000);
        public WHBillboardOrderStatus()
        {
            InitializeComponent();
            
        }

        private void WHBillboardOrderStatus_Load(object sender, EventArgs e)
        {
        ...
        public void status()
        {
            try
            {
                ...
                int allBox = 0;
                int useBox = 0, emptyBox = 0;
                allBox = storeN * 2 * 3 * 5;
                //useBox = 100;
                emptyBox = allBox - useBox;
                int allcarcon = 130000;
                int cartonnum = 0;
                int cartonmin = 0;
                ...
                List<string> xData = new List<string>() { "Empty", "Storage" };
                List<int> yData = new List<int>() { cartonmin, cartonnum };
                //线条颜色
